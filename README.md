...
- In Play Screen
  ...
  (you can't undo, redo because we only save the game states except list move).
...
- New game:
  + If you want to play with AI (1 player Mode):
    1 player -> Choose Level (easy, medium, hard) -> Choose Team (white, black, random).
  + If you want to play 2 player Mode: 2 playe
- You can flip the board by reversing button right under screen. (The reason why we think don’t
